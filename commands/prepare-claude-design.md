...
└── planning/    # scope, IA, flows, journeys, inventory, and open decisions
```
...
3. Explain that Claude Design's completed export must be placed under
   `design/prototypes/`, `design/system/`, and `design/planning/`.
