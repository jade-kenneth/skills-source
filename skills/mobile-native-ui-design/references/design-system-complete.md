# Mobile Native UI Design — Complete Reference

This is the complete design-system reference. The routing and authority contract
lives in the parent `SKILL.md`; read only the sections relevant to the current
task.
